...
public class ConfigurationFilesNode extends FilterNode {

    @StaticResource
    private static final String IMAGE = "org/webino/"
            + "webino/configBadge.gif";

    public ConfigurationFilesNode(Project proj) throws DataObjectNotFoundException {
        super(DataObject.find(proj.getProjectDirectory().
                getFileObject("config")).getNodeDelegate());
    }
