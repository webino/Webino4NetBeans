...
public class LogFilesNodeFactory implements NodeFactory {
    ...
    public NodeList createNodes(Project project) {
        ...
        FileObject item = project.getProjectDirectory().getFileObject("._dev/webinozf1skeletonapplication/#system/data/log");
        if (item != null) {
            try {
                LogFilesNode nd = new LogFilesNode(project);
