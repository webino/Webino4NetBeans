...
public class LogFilesNode extends FilterNode {

    @StaticResource
    private static final String IMAGE = "org/webino/"
            + "webino/configBadge.gif";

    public LogFilesNode(Project proj) throws DataObjectNotFoundException {
        super(DataObject.find(proj.getProjectDirectory().
                getFileObject("._dev/webinozf1skeletonapplication/#system/data/log")).getNodeDelegate());
    }
