...
public class DocFilesNodeFactory implements NodeFactory {
    ...
    public NodeList createNodes(Project project) {
        ...
        FileObject item = project.getProjectDirectory().getFileObject("doc");
        if (item != null) {
            try {
                DocFilesNode nd = new DocFilesNode(project);
