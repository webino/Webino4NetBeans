...
public class LanguageFilesNode extends FilterNode {

    @StaticResource
    private static final String IMAGE = "org/webino/"
            + "webino/configBadge.gif";

    public LanguageFilesNode(Project proj) throws DataObjectNotFoundException {
        super(DataObject.find(proj.getProjectDirectory().
                getFileObject("language")).getNodeDelegate());
    }
