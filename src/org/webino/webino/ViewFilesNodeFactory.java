...
public class ViewFilesNodeFactory implements NodeFactory {
    ...
    public NodeList createNodes(Project project) {
        ...
        FileObject item = project.getProjectDirectory().getFileObject("view");
        if (item != null) {
            try {
                ViewFilesNode nd = new ViewFilesNode(project);
