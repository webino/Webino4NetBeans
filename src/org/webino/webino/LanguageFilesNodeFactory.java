...
public class LanguageFilesNodeFactory implements NodeFactory {
    ...
    public NodeList createNodes(Project project) {
        ...
        FileObject item = project.getProjectDirectory().getFileObject("language");
        if (item != null) {
            try {
                LanguageFilesNode nd = new LanguageFilesNode(project);
